  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center relative overflow-hidden bg-background">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        ...
        <div className="absolute -bottom-[20%] -right-[10%] w-[40%] h-[60%] rounded-full bg-primary/20 blur-[100px]" />
      </div>

      <div className="w-full max-w-lg px-8 py-10 rounded-2xl bg-card/40 backdrop-blur-xl border border-white/10 shadow-2xl my-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-zinc-400 text-center">
            Оставьте заявку на подключение компании к платформе HexaCash
          </p>
        </div>
        ...
        <form className="space-y-4" action="">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-300" htmlFor="firstName">
                Имя
              </label>
              <input
                id="firstName"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-300" htmlFor="lastName">
                Фамилия
              </label>
              <input
                id="lastName"
          ...
          <button
            type="button"
            className="w-full py-3 px-4 bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-xl transition-colors shadow-lg shadow-primary/25 mt-4"
          >
            Подать заявку
          </button>
        </form>
